...
module ActiveRecord
  ...
  module Persistence
    ...
    module ClassMethods
      ...
      def insert(attributes, returning: nil, unique_index: nil)
        insert_all([ attributes ], returning: returning, unique_index: unique_index)
      end
      ...
      #
      #     unique_index: :index_books_on_isbn
      #
      # ==== Example
      #
      ...
      #   ])
      #
      def insert_all(attributes, returning: nil, unique_index: nil)
        InsertAll.new(self, attributes, on_duplicate: :skip, returning: returning, unique_index: unique_index).execute
      end
      ...
      def upsert(attributes, returning: nil, unique_index: nil)
        upsert_all([ attributes ], returning: returning, unique_index: unique_index)
      end
      ...
      #   ], unique_index: :index_books_on_isbn)
      def upsert_all(attributes, returning: nil, unique_index: nil)
        InsertAll.new(self, attributes, on_duplicate: :update, returning: returning, unique_index: unique_index).execute
      end
